        ...
        <div className="rounded-[34px] bg-offWhite p-6 shadow-custom md:p-12">
          ...
          <header className="mb-10 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[14px] text-secondary/80 md:text-[16px]">
              If you wish to delete all your data from the PAIA app, please enter
              your email and password below. This action will remove your stored
              information while keeping your account active.
            </p>
          </header>
